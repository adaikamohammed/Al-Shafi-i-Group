...
export function isSheikhMenUser(u: any): boolean {
  ...
  return (emailNum !== null && ((emailNum >= 1 && emailNum <= 9) || emailNum === 20 || emailNum === 21 || emailNum === 22)) || 
         (groupNum !== null && ((groupNum >= 1 && groupNum <= 9) || groupNum === 20 || groupNum === 21 || groupNum === 22)) ||
...
export function isStudentInMenSheikhs(s: any, allUsers: any[]): boolean {
  ...
  return groupNum !== null && ((groupNum >= 1 && groupNum <= 9) || groupNum === 20 || groupNum === 21 || groupNum === 22);
}
...
export const GROUP_SHEIKH_MAPPING: Record<string, string> = {
  ...
  "فوج 22": "الشيخ عبد الرحمان كنيوة",
  "فوج 1 إبتدائي": "",
};
