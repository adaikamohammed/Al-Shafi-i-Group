...
export default function ActivityLogsPage() {
    ...
    useEffect(() => {
        ...
        const logPath = (isSuperAdmin || isManagement) ? 'activity_logs' : `users/${user.uid}/activity_logs`;
    ...
    }, [user, isManagement, isSuperAdmin]);
        ...
        <div className="min-h-screen p-6 space-y-8 font-body" dir="rtl">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                <div>
                    ...
                    <p className="text-muted-foreground mt-1 text-lg">مراقبة التحديثات والعمليات اليومية في فوجك.</p>
                </div>
            ...
            <div className="bg-card rounded-2xl p-5 shadow-sm border border-border grid grid-cols-1 md:grid-cols-3 gap-4 sticky top-4 z-10 backdrop-blur-xl bg-card/90">
                ...
                <div className="relative">
                    ...
                    <select
                        ...
                        title="تصفية حسب العملية"
                        className="w-full pl-4 pr-10 py-3 rounded-xl bg-muted/50 border-transparent focus:bg-card focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all outline-none appearance-none cursor-pointer"
                        value={filterAction}
